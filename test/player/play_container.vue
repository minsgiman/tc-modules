<template>
    <div id="play_container">
        ...
        <div class="camdtl_wrap nvr_hidden_right_none" style="width:960px;">
            <div>
                                ...
                                <div id="controlNdTimeLine">
                                    ...
                                    <div class="cam_ctrl" id="view_cam_ctrl">
                                        <div v-show="isShowControlButton">
                                            ...
                                            <div class="event_move" v-show="isFullScreen && !cloudOut" style="opacity:0;">
                                            ...
                                            <div class="menu">
                                                <button type="button" style="opacity:0;" class="sp" :class="{
...
<script>
    ...
    import $ from 'jquery';
    import toastcamAPIs from '../../src/service/toastcamAPIs';
